...
| State source | Kalman posterior / raw sensor fallback | Standalone CLI reads file/state payload; production DB/API integration is implemented in `Green-House/Green-House-master` |
