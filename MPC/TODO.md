...
- [x] #007 - Add v3 closed-loop HTTP actuator pilot with fail-safe [area: backend] -> [.tasks/007-v3-http-actuator-pilot.md](.tasks/007-v3-http-actuator-pilot.md)
- [x] #006 - Implement v3 AMPC bias adaptation layer [area: backend] -> [.tasks/006-v3-bias-adaptation-layer.md](.tasks/006-v3-bias-adaptation-layer.md)
...
- [x] #001 - Design MPC package architecture and default config [area: planning] -> [.tasks/001-design-mpc-package-architecture.md](.tasks/001-design-mpc-package-architecture.md)
- [x] #000 - Initial MPC project setup and onboarding documentation [area: setup] -> [.tasks/000-initial-project-setup.md](.tasks/000-initial-project-setup.md)
