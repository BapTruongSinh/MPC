...
# Adaptive Kalman + AMPC Design System and UX Specifications

> Last updated: 2026-04-14
> Version: 0.2.0

Canonical design language, component inventory, interaction patterns, and summaries of major user journeys. The reusable UI system is not defined yet; v1 needs a practical technical dashboard for raw signal, prediction output, Adaptive Kalman-ready filtered signal, and AMPC-readiness review.
...
|------|------|---------------|-------|
| Dataset replay | Run `../ARX/greenhouse_data.csv` through the estimation pipeline | TBD | See FR-001, FR-020, task #003 |
| Estimation review | Compare raw, predicted, and filtered signals | Dashboard or generated plots | See FR-018, task #009 |
| Evaluation export | Produce report-ready evidence for v1 | TBD | See FR-021, task #008 |
