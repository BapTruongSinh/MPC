...
- [x] #016 - Split Kalman algorithm package from Django server [area: backend] -> [.tasks/016-split-kalman-package-server.md](.tasks/016-split-kalman-package-server.md)
- [x] #015 - Implement Django AMPC online integration [area: backend] -> [.tasks/015-django-ampc-online-integration.md](.tasks/015-django-ampc-online-integration.md)
- [x] #014 - Add greenhouse ownership scope for live data [area: database] -> [.tasks/014-add-greenhouse-ownership-scope.md](.tasks/014-add-greenhouse-ownership-scope.md)
