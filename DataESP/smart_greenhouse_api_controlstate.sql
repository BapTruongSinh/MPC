...
DROP TABLE IF EXISTS `api_controlstate`;
...
CREATE TABLE `api_controlstate` (
  ...
  `manual_reason` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
LOCK TABLES `api_controlstate` WRITE;
/*!40000 ALTER TABLE `api_controlstate` DISABLE KEYS */;
INSERT INTO `api_controlstate` VALUES (1,'2026-06-09 08:31:03.775044','2026-06-09 10:34:11.129435','main','AUTO','',NULL,NULL);
/*!40000 ALTER TABLE `api_controlstate` ENABLE KEYS */;
UNLOCK TABLES;
