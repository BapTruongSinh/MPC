...
**Coverage target: 80%** for new features. Below 80% on a new feature is a review blocker. Existing files below 80% are tracked in `Kalman/TODO.md` — do not reduce coverage further.
