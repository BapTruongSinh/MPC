...
describe('SliceChart', () => {
  it('shows empty state when data is empty', () => {
    render(<SliceChart data={[]} sliceLabel="online" />)
  ...
  it('renders a section with accessible label', () => {
    ...
    render(<SliceChart data={data} sliceLabel="online" />)
    expect(
      screen.getByRole('region', { name: /time-series chart for online/i }),
    ).toBeInTheDocument()
  })
  ...
  it('renders chart with SVG', () => {
    ...
    const { container } = render(<SliceChart data={data} sliceLabel="online" />)
