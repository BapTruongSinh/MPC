---
id: "004"
title: "Create replaceable prediction adapter contract with ARX baseline"
status: "todo"
area: "backend"
...
Start from `../ARX/arx_pipeline.py` and `../ARX/arx_model.json` if those are the current reusable artifacts. Treat ARX as the baseline prediction model, not the only model the architecture will ever allow.
